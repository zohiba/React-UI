...
class BadRequest extends Component {
    ...
    async componentDidMount() {
        ...
        const response = await fetch('http://localhost:8091/scenarios/badRequest/executions', {
            method: 'GET',
            headers: headers
        });
        //console.log("here");
        ...
        for (let i in body) {
            ...
            if (obj["successful"] || obj["completed"]) {
                ...
                for (let callIndex in callLegs) {
                    ...
                    if (obj["id"]== "de02bb26-1f41-4de4-8e4e-2fe4d1649793"){
                        console.log(alllegheader);
                    }
                ...
                {this.state.exeInfo.map(function(execution){
                    ...
                    return (
                        ...
                        <tr>
                            ...
                            <TableData link={"http://localhost:8091/scenarios/badRequest"} exeid={execution["id"]} icon={execution["id"]}/>
