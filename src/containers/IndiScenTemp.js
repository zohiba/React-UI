...
class Individual extends Component {
    ...
    render() {
        ...
        return (
            <div class="table-responsive" style={{padding: "30px"}}> <h3 style={{color:"black"}}>  {scenario.toUpperCase()} </h3><p><i> {this.state.description}</i></p>
                <Table
                    headers={
                        <React.Fragment>
                    <Table.Row>
                        <Table.Header style={{width:"20px"}}>Execution</Table.Header>
                        <Table.Header style={{width:"30px"}}>Time</Table.Header>
                        <Table.Header style={{width:"30px"}}>Unexpected<br/>Callback</Table.Header>
                            {legs.map(function(item){
                                return (
                                    <Table.Header style={{textAlign:"center"}} colSpan={headers[item].length.toString()}>{"Call Leg"+item}</Table.Header>
                                )})}
                    </Table.Row>
                    <Table.Row>
                    ...
                    {this.state.exeInfo.map(function(execution){
                        ...
                        return (
                            ...
                            <Table.Row>
                                ...
                                <Table.Cell className={execution['prob']}>{execution["prob"]}</Table.Cell>
                                            ...
                                            return [
                                                ...
                                                ...allevents.map((event) => {
                                                    ...
                                                    if (event.event === head) {
                                                        ...
                                                        gotit = 1;
                                                        return <Table.Cell className={event.valid.toString()}></Table.Cell>;
                                                    }
