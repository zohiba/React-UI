...
class ForwardScenario extends Component {
    ...
    async componentDidMount() {
        ...
        const response = await fetch('http://localhost:8091/scenarios/forwardBxml/executions', {
            method: 'GET',
            headers: headers
        });
                ...
                {this.state.exeInfo.map(function(execution){
                    ...
                    return (
                        ...
                        <tr>
                            ...
                            <TableData link={"http://localhost:8091/scenarios/forwardBxml"} exeid={execution["id"]} icon={execution["id"]}/>
...
export default ForwardScenario;
