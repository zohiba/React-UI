...
class Gather extends Component {
    ...
    async componentDidMount() {
        ...
        const response = await fetch('http://localhost:8091/scenarios/gather/executions', {
            method: 'GET',
            headers: headers
        });
        //console.log("here");
                ...
                {this.state.exeInfo.map(function(execution){
                    ...
                    return (
                        ...
                        <tr>
                            ...
                            <TableData link={"http://localhost:8091/scenarios/gather"} exeid={execution["id"]} icon={execution["id"]}/>
